...
describe('Activities List', () => {
  ...
  describe('With activities', () => {
    ...
    it('should fetch activity for main user', async () => {
      ...
      expect(useRouter.mock.results[1].value.push).toHaveBeenCalledWith('/mock-user/activities/Quran')
    })
    ...
    it('should fetch activity for non-main user', async () => {
      ...
      expect(useRouter.mock.results[1].value.push).toHaveBeenCalledWith('/mock-user/students/mock-student/activities/Quran')
    })
