  ...
  describe('Submitting', () => {
    ...
    describe('With juz', () => {
      ...
      it('should invoke createCards controller with card for juz and no associated surahs', async () => {
        ...
        (createCards as jest.Mock).mockImplementationOnce(() => {
          return Promise.resolve({status: 200, data: {message: 'Cards added', details: [userCardWithJuz]}})
        });
        ...
        render(<AddQuranCardForm  {...{isMain: true, user: updatedUser, activity: updatedActivity}}/>)
