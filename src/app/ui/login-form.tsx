  ...
  return (
    <>
      <form className="space-y-6" onSubmit={submitForm} method="POST">
        <div>
          <label htmlFor="userId" className="block text-sm font-medium leading-6 text-gray-900">Username or Email:</label>
          <div className="mt-2">
            <input onChange={handleInput} value={formData.userId} id="userId" name="userId" type="text" autoComplete="userId" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
