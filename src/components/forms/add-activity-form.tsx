...
const AddActivityForm = ({
  ...
  return (
    <>
      <form data-testid="add-activity-form" className="space-y-6" onSubmit={submitForm} method="POST">
        ...
        <span>
          <button data-testid="add-activity-btn" type="submit" disabled={isLoading} className="mt-5 rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add activity</button>
        </span>
      </form>
    </>
  )
