...
export default function ValidatePopup({onClose, showModal, ...childArgs}: 
  ...
  return (
    <>
      <div data-testid="validate-popup" hidden={!showModal} id="popup-modal" className="fixed top-1/2 left-1/2 right-1/2 z-50 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full border-4 border-gray-800 rounded-lg">
