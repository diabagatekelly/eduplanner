...
const DeleteActivityPopup = ({onClose, showModal, ...childArgs}: {onClose: any, showModal: boolean, item?: {activityName: string}, user?: IUser | Partial<IUser>}) => {
  ...
  return (
    <>
      <div data-testid="delete-activity-popup" hidden={!showModal} id="popup-modal" className="fixed top-0 left-0 right-0 z-50 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full border-4 border-gray-800 rounded-lg">
